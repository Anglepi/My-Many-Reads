...
\begin{enumerate}[label=\textbf{O-\arabic*}]
    ...
    \item Permitir a los usuarios participar activamente en creación de contenido de la plataforma a través de recomendaciones entre libros personalizadas, reviews y publicaciones en foros de discusiones.
...
\begin{itemize}[label=\textbf{F-\arabic*}]
