...
Anteriormente en la sección de planificación se mostró una descripción de la \hyperref[Planificacion]{\underline{temporización del proyecto}}. Dado que se sigue una filosofía ágil para el proyecto, al principio de este era inviable plantear una planificación temporal completa.
