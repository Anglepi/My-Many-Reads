...
\item Un sistema de recomendaciones automático en función de los libros incluídos en tu biblioteca.
...
\item Al consultar los libros relacionados con uno en concreto, no especifican por qué estan relacionados con éstos salvo por \textit{"A muchos usuarios también les gustó este otro libro"}. Más detalles del por qué están relacionados ayudarían a un usuario a tomar una decisión.
\item La abundancia de funcionalidades \textit{"Nice to have"} como los \textit{challenges}, \textit{quizs}, etc. distraen al usuario de la funcionalidad principal.
\end{itemize}
