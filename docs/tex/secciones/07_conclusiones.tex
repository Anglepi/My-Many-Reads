...
También me ha permitido reafirmar algunas sospechas sobre ciertas formas de organizar el trabajo. Comencé pensando, erróneamente, que al ser un único desarrollador, el tamaño de las epopeyas y tareas refinadas debía más pequeño. Tras un primer intento de aplicar esta filosofía me dí cuenta de que los costes en tiempo de la gestión administrativa de estas tareas empezaban a ser bastante altos en proporción al tiempo necesario para resolver dichas tareas, es decir, programar.
