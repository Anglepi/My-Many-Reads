...
Por desgracia, a pesar de ser una gran opción que acompaño a prácticamente todo el desarrollo del proyecto hasta la fecha, esta plataforma fue absorbida por \textit{Databricks}, cerrando su servicio el 30 de junio de 2023. En la documentación publicada con el comunicado de esta noticia ofrecen una \href{https://docs.bit.io/docs/sunset#alternative-postgres-providers}{lista de posibles alternativas} con servicios similares.
