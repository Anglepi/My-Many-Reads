...
Esta se encarga de ejecutar un \href{https://github.com/Anglepi/My-Many-Reads/blob/main/scripts/spellcheck.sh}{\textit{script}} incluido en el repositorio que hace uso de \href[aspell]{\underline{\textit{Aspell}}} para realizar una corrección ortográfica.
