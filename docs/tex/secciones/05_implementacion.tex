...
\begin{itemize}
    \item \href{https://github.com/Anglepi/My-Many-Reads/issues/}{\textbf{HT-3}} Creación de la API. \\
    Es necesario tener una API para realizar todas las tareas tipo CRUD. \\
    ...
    \item \href{https://github.com/Anglepi/My-Many-Reads/issues/}{\textbf{HU-4}} Sistema de recomendaciones manuales. \\
    Como Sergio, lector en MMR, \\
    ...
    \item \href{https://github.com/Anglepi/My-Many-Reads/issues/}{\textbf{HU-5}} Sistema de recomendaciones automático. \\
    Como Sergio, lector en MMR, \\
