...
Una vez conocidos sus gustos, habrá que explorar una colección de libros que no incluyan los que el usuario ya ha leido, y estudiar como encaja cada uno de estos nuevos libros con los de la librería dada por el usuario. Cuanto más similar sea un libro candidato con los gustos definidos por el usuario, más probable es que se trate de una buena recomendación.
