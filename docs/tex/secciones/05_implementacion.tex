...
\textbf{Biblioteca de aserciones:} \href{https://github.com/assertpy/assertpy}{assertpy}

Una biblioteca con varias funciones de aserciones para encapsular todo el proceso de \textit{assert} junto con las comprobaciones pertinentes. Partiendo de la función \textit{assert_that} y encadenando otras, permite construir aserciones en lenguaje casi natural.
