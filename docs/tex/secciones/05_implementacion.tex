...
\begin{itemize}
    ...
    \begin{itemize}
        \item name: string
        \item owner: string
        \item entries: list<Entry>
    \end{itemize}
    \item \textbf{Entry}
    \begin{itemize}
        \item book\_id: string
        \item score: int
        \item status: list<one of ["PLAN TO READ", "CURRENTLY READING", "COMPLETED", "DROPPED", "ON HOLD"]>
    \end{itemize}
\end{itemize}
