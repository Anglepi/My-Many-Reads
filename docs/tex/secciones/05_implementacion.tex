...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textit{/recommendations/\{book_id\}}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textit{/libraries/\{user\}/\{library\}}
        \item \textit{/libraries/\{user\}/\{library\}/\{book_id\}}
    \end{itemize}
    \item Recommendations:
    \begin{itemize}
        \item \textit{/recommendations/\{book_id1\}/\{book_id2\}/\{user\}}
        \item \textit{/recommendations/\{book_id1\}/\{book_id2\}/\{user\}/\{comment\}}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{/libraries/\{user\}/\{library\}/\{book_id\}/\{score\}/\{status\}}
    \end{itemize}
\end{itemize}
