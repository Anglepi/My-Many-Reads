...
\begin{itemize}
    ...
    \item Después, se recorrerá una lista de libros candidatos, entre los cuales no debería haber ninguno leido por el usuario, y de alguna forma se calculará su nivel de compatibilidad con este perfil de gustos.
...
\subsubsection{Constuyendo el perfil de gustos}
