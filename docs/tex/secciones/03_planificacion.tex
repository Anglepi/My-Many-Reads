...
Con varias de estas epopeyas se definiría un \textit{milestone} que, como se indica en el apartado anterior, representa un PMV. Lo ideal sería que cada PMV se desarrollase en entre 4 y 6 semanas, lo que significa apróximadamente 4 epopeyas por PMV, pero es posible que en algunos casos se requierá más o menos tiempo o epopeyas para completar un \textit{milestone}.
